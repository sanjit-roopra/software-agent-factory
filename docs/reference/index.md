...
[CLI](cli.md)
: Every command, argument, default, and exit code.

[Configuration file](configuration.md)
: Every key in the factory YAML, with its default and effect.

[Model selection, cost and benchmarks](model-selection.md)
